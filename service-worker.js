const SHELL_CACHE = "ashare-shell-20260723-freshness-3";
const DATA_CACHE = "ashare-data-20260723-freshness-3";
...
const APP_SHELL = [
  ...
  new URL("mobile/app.js?v=20260723-freshness3", ROOT_URL).href,
